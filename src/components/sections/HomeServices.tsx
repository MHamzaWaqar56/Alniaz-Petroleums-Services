...
const services = [
  ...
  { id: "05", title: "Zoom Mart", category: "Tuck Shop", description: "Cold drinks, snacks, and travel essentials open 24/7.", image: "/assets/shop.jpeg", icon: ShoppingBag, link: "/services" },
